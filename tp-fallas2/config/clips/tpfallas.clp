...
(deffacts MAIN::disenio
   ...
   (product_dis_interf_hardDesSoftSinMod SI)
   ...
   (product_dis_limHard_limHabCumpReq SI)
...
(defrule MAIN::print_riesgo_desarrollo
   ...
   =>
      (assert (answer (pos 5) (name riesgo.desarrollo))))
...
(defrule MAIN::print_riesgo_ingenieria
   ...
   =>
   (assert (answer (pos 4)(name riesgo.ingenieria))))
...
(defrule MAIN::print_riesgo_pruebas
   ...
   =>
   (assert (answer (pos 3) (name riesgo.pruebas))))
